// Ported VERBATIM from apps/box/src/utils/findPendingQuestion.ts (strict-TS index guard only)
/**
 ...
 */
import type { UserQuestionEvent, TranscriptEntry } from './bloxAiEvents';
